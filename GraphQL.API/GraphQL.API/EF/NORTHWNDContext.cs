...
namespace GraphQL.API.EF
{
    public partial class NORTHWNDContext : DbContext
    {
        ...
        // Unable to generate entity type for table 'dbo.test_av'. Please see the warning messages.
        // Unable to generate entity type for table 'dbo.friends'. Please see the warning messages.
        // Unable to generate entity type for table 'dbo.Location'. Please see the warning messages.
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            {
                entity.Property(e => e.RepoType).HasMaxLength(100);
